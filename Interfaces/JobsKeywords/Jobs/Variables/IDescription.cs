...
public interface IJobs_Variables_Description:
...
public interface IJobs_Variables_Description_Navigation_lvl_4{
    public IJobs_Variables_Description Description(string description);
}