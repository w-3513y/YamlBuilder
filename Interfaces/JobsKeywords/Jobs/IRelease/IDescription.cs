...
public interface IJobs_Release_Description:
...
public interface IJobs_Release_Description_Navigation_lvl_3{
    public IJobs_Release_Description Description(string description);
}