...
public interface IJobs_Release_Ref:
...
{
    public void Build(string reference);
}

public interface IJobs_Release_Ref_Navigation_lvl_2{
    public IJobs_Release_Ref Ref(string reference);
}