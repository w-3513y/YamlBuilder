...
public interface IJobs_Cache_Files:
    ...
    IJobs_Cache_Prefix_Navigation
{
    public void Build(string[] files);
}

public interface IJobs_Cache_Files_Navigation_lvl_3{
    public IJobs_Cache_Files Files(string[] files);   
}