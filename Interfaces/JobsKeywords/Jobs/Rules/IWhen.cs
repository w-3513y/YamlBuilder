...
public interface IJobs_Rules_When:
...
{
    public void Build(Enums.When when);
}

public interface IJobs_Rules_When_Navigation_lvl_3{
    public IJobs_Rules_When When(Enums.When when);
}