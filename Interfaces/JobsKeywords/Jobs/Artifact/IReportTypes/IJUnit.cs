...
public interface IJobs_Artifact_Report_JUnit:
...
public interface IJobs_Artifact_Report_JUnit_Navigation_lvl_3{
    public IJobs_Artifact_Report_JUnit JUnit(string report);
}