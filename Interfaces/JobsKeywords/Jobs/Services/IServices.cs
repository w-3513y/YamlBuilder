...
public interface IJobs_Services:
  IJobs_Services_NameNavigation_lvl_2
{}

public interface IJobs_Services_ShortSyntax:
...
public interface IJobs_Services_Navigation_lvl_1{
    public IJobs_Services Services();   
    public IJobs_Services_ShortSyntax Services(string[] commands);
}