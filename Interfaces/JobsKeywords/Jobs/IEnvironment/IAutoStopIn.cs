...
public interface IJobs_Environment_AutoStopIn:
...
{
    public void Build(string days);
}

public interface IJobs_Environment_AutoStopIn_Navigation_lvl_3{
    public IJobs_Environment_AutoStopIn AutoStopIn(string days);   
}
