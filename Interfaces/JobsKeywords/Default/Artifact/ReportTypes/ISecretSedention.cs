...
public interface IDefault_Artifacts_Report_SecretSedention:
...
public interface IDefault_Artifacts_Report_SecretSedention_Navigation_lvl_3{
    public IDefault_Artifacts_Report_SecretSedention SecretSedention(string report);
}